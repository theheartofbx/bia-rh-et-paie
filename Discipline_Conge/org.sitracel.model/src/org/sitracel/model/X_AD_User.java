...
public class X_AD_User extends PO implements I_AD_User, I_Persistent
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20251228L;
...
// X
	...
	*/
	...
	/** Set IsHRDefault.
		@param IsHRDefault User default for Human Resouce
	*/
	public void setIsHRDefault (boolean IsHRDefault)
	{
		set_Value (COLUMNNAME_IsHRDefault, Boolean.valueOf(IsHRDefault));
	}

	/** Get IsHRDefault.
		@return User default for Human Resouce
	  */
	public boolean isHRDefault()
	{
		Object oo = get_Value(COLUMNNAME_IsHRDefault);
		if (oo != null)
		{
			 if (oo instanceof Boolean)
				 return ((Boolean)oo).booleanValue();
