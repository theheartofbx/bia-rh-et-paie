...
public class X_HR_Parametre_Numerique extends PO implements I_HR_Parametre_Numerique, I_Persistent
{
    ...
    public X_HR_Parametre_Numerique (Properties ctx, int HR_Parametre_Numerique_ID, String trxName)
    {
      ...
      /** if (HR_Parametre_Numerique_ID == 0)
        {
			setHR_Parametre_Numerique_ID (0);
			setName (null);
        } */
    }

    /** Standard Constructor */
    public X_HR_Parametre_Numerique (Properties ctx, int HR_Parametre_Numerique_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Parametre_Numerique_ID, trxName, virtualColumns);
      /** if (HR_Parametre_Numerique_ID == 0)
        {
			setHR_Parametre_Numerique_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_HR_Parametre_Numerique (Properties ctx, String HR_Parametre_Numerique_UU, String trxName)
    {
      super (ctx, HR_Parametre_Numerique_UU, trxName);
      /** if (HR_Parametre_Numerique_UU == null)
        {
			setHR_Parametre_Numerique_ID (0);
			setName (null);
        } */
    ...
    /** Standard Constructor */
    public X_HR_Parametre_Numerique (Properties ctx, String HR_Parametre_Numerique_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Parametre_Numerique_UU, trxName, virtualColumns);
      /** if (HR_Parametre_Numerique_UU == null)
        {
			setHR_Parametre_Numerique_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Parametre_Numerique (Properties ctx, ResultSet rs, String trxName)
    {
