...
public class X_HR_Formulaire extends PO implements I_HR_Formulaire, I_Persistent
{
    ...
    {
      super (ctx, HR_Formulaire_ID, trxName);
      /** if (HR_Formulaire_ID == 0)
        {
			setHR_Formulaire_ID (0);
			setName (null);
        } */
    }

    /** Standard Constructor */
    public X_HR_Formulaire (Properties ctx, int HR_Formulaire_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Formulaire_ID, trxName, virtualColumns);
      /** if (HR_Formulaire_ID == 0)
        {
			setHR_Formulaire_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_HR_Formulaire (Properties ctx, String HR_Formulaire_UU, String trxName)
    {
      super (ctx, HR_Formulaire_UU, trxName);
      /** if (HR_Formulaire_UU == null)
        {
			setHR_Formulaire_ID (0);
			setName (null);
        } */
    ...
    /** Standard Constructor */
    public X_HR_Formulaire (Properties ctx, String HR_Formulaire_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Formulaire_UU, trxName, virtualColumns);
      /** if (HR_Formulaire_UU == null)
        {
			setHR_Formulaire_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Formulaire (Properties ctx, ResultSet rs, String trxName)
    {
