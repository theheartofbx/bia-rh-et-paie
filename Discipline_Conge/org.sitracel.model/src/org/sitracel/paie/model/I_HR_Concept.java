...
public interface I_HR_Concept 
{
    ...
    /** Column name Bia_BaseElmt_ID */
    public static final String COLUMNNAME_Bia_BaseElmt_ID = "Bia_BaseElmt_ID";
    ...
    /** Column name Bia_Pourcentage */
    public static final String COLUMNNAME_Bia_Pourcentage = "Bia_Pourcentage";
    ...
    /** Column name IEXT_HR_FiscalSocial_Indicator */
    public static final String COLUMNNAME_IEXT_HR_FiscalSocial_Indicator = "IEXT_HR_FiscalSocial_Indicator";

	/** Set Indicateur Fiscal et Social.
	  * Indicateur Fiscal et Social
	  */
