...
public class CalloutMajRetenueSalarialeFinPeriode implements IColumnCallout{
	...
	public String start(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
		...
		Integer periodeDebutID = (Integer) mTab.getValue(MHRRetenueSalariale.COLUMNNAME_Debut_Prelevement_ID);
		...
		if(nombreMensualite!=null && periodeDebutID!=null) {
			...
			if(periodeDebut!=null) {
				...
				if(periodeFin!=null) {
					mTab.setValue(MHRRetenueSalariale.COLUMNNAME_Fin_Prelevement_ID, periodeFin.getHR_Periode_Salariale_ID());
					mTab.setValue(MHRRetenueSalariale.COLUMNNAME_Date_Debut, periodeDebut.getDate_Debut_Defaut());
				}
				else {
					mTab.setValue(MHRRetenueSalariale.COLUMNNAME_Fin_Prelevement_ID, null);
					mTab.setValue(MHRRetenueSalariale.COLUMNNAME_Date_Debut, null);
				}
			}
		}
		return null;
