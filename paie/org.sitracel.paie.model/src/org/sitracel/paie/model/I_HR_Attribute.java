...
public interface I_HR_Attribute
{
    ...
    /** Column name Actualiser */
    public static final String COLUMNNAME_Actualiser = "Actualiser";
    ...
    /** Column name HR_ConceptFrom_ID */
    public static final String COLUMNNAME_HR_ConceptFrom_ID = "HR_ConceptFrom_ID";
    ...
    /** Column name IEXT_HourlyRate */
    public static final String COLUMNNAME_IEXT_HourlyRate = "IEXT_HourlyRate";
    ...
    /** Column name IEXT_StandartHours */
    public static final String COLUMNNAME_IEXT_StandartHours = "IEXT_StandartHours";
    ...
    /** Column name Periode_Reference_Debut */
    public static final String COLUMNNAME_Periode_Reference_Debut = "Periode_Reference_Debut";

	/** Set Début de la période de Reférence.
	  * Début de la période de Reférence
	  */
    ...
    /** Column name Periode_Reference_Fin */
    public static final String COLUMNNAME_Periode_Reference_Fin = "Periode_Reference_Fin";

	/** Set Fin de la période de Reférence.
	  * Fin de la période de Reférence
	  */
