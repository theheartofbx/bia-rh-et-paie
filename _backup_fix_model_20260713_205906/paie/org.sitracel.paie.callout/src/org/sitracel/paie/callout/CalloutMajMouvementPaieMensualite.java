...
public class CalloutMajMouvementPaieMensualite implements IColumnCallout {
    ...
    public String start(Properties ctx, int WindowNo, GridTab mTab,
        ...
        mTab.setValue(MHRMouvementPaie.COLUMNNAME_IsRecurrent, recurrent ? "Y" : "N");
        ...
        if (recurrent) {
            ...
            mTab.setValue(MHRMouvementPaie.COLUMNNAME_Solde,                       null);
            return null;
        }
        ...
        mTab.setValue(MHRMouvementPaie.COLUMNNAME_Solde,                        base);
