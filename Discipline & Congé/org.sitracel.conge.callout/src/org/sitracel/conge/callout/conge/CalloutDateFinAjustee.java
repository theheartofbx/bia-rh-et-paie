...
public class CalloutDateFinAjustee implements IColumnCallout{
	...
	public String start(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
		...
		if(dateFin!=null) {
			...
			if(ajustementAuto) {
				...
				if(nbJour!=null) {
					Timestamp dateDebutn = CalloutController.retirerNombreJour(dateFin, nbJour);
					mTab.setValue(MHRHoliday.COLUMNNAME_Date_Debut_Ajustee, dateDebutn);
					mTab.setValue(MHRHoliday.COLUMNNAME_Date_Debut_Effective, dateDebutn);
				}
			}
			else*/
			if(dateDebut!=null) {
