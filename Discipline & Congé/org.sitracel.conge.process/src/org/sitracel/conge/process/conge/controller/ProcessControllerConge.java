...
public class ProcessControllerConge {
	...
	public static void setIsCongeValide(Integer idConge, Integer adUserID) {
		if(idConge!=null && adUserID!=null) {
			...
			if(conge!=null && bi!=null) {
				if(bi.getNomEmploye()!=null) {
					...
					conge.setValide_Rejete_Par_Nom_ID(bi.getNumEmploye());
					conge.setValide_Rejete_Par_Matricule(bi.getMatriculeEmploye());
					conge.setValide_Rejete_Par_Poste_ID(bi.getNumeroPoste());
	...
	public static void setIsCongeReject(Integer idConge, Integer adUserID) {
		if(idConge!=null && adUserID!=null) {
			BeanIdentifiant bi = ProcessSqlControllerConge.getBeanIdentifiant(adUserID, null);
			MHRHoliday conge = new MHRHoliday(Env.getCtx(), idConge, null);
			if(conge!=null && bi!=null) {
	...
	public static void setIsCongeApprouve(Integer idConge, Integer adUserID) {
		if(idConge!=null && adUserID!=null) {
			BeanIdentifiant bi = ProcessSqlControllerConge.getBeanIdentifiant(adUserID, null);
			MHRHoliday conge = new MHRHoliday(Env.getCtx(), idConge, null);
			if(conge!=null && bi!=null) {
	...
	public static void setIsCongeDesapprouve(Integer idConge, Integer adUserID) {
		if(idConge!=null && adUserID!=null) {
			BeanIdentifiant bi = ProcessSqlControllerConge.getBeanIdentifiant(adUserID, null);
			MHRHoliday conge = new MHRHoliday(Env.getCtx(), idConge, null);
			if(conge!=null && bi!=null) {
