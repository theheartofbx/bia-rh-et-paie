...
/** Generated Model for HR_Candidat_Formation
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="HR_Candidat_Formation")
public class X_HR_Candidat_Formation extends PO implements I_HR_Candidat_Formation, I_Persistent
{
    ...
    public X_HR_Candidat_Formation (Properties ctx, int HR_Candidat_Formation_ID, String trxName)
    {
      super (ctx, HR_Candidat_Formation_ID, trxName);
      /** if (HR_Candidat_Formation_ID == 0)
        {
			setC_BPartner_ID (0);
			setHR_Candidat_Formation_ID (0);
    ...
    /** Standard Constructor */
    public X_HR_Candidat_Formation (Properties ctx, int HR_Candidat_Formation_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Candidat_Formation_ID, trxName, virtualColumns);
      /** if (HR_Candidat_Formation_ID == 0)
        {
			setC_BPartner_ID (0);
			setHR_Candidat_Formation_ID (0);
    ...
    /** Standard Constructor */
    public X_HR_Candidat_Formation (Properties ctx, String HR_Candidat_Formation_UU, String trxName)
    {
      super (ctx, HR_Candidat_Formation_UU, trxName);
      /** if (HR_Candidat_Formation_UU == null)
        {
			setC_BPartner_ID (0);
			setHR_Candidat_Formation_ID (0);
			setHR_Etablissement_ID (0);
    ...
    /** Standard Constructor */
    public X_HR_Candidat_Formation (Properties ctx, String HR_Candidat_Formation_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, HR_Candidat_Formation_UU, trxName, virtualColumns);
      /** if (HR_Candidat_Formation_UU == null)
        {
			setC_BPartner_ID (0);
			setHR_Candidat_Formation_ID (0);
    ...
    /** Load Constructor */
    public X_HR_Candidat_Formation (Properties ctx, ResultSet rs, String trxName)
    {
	...
	*/
	...
	public I_HR_Etablissement getHR_Etablissement() throws RuntimeException
	{
		return (I_HR_Etablissement)MTable.get(getCtx(), I_HR_Etablissement.Table_ID)
			.getPO(getHR_Etablissement_ID(), get_TrxName());
	}
