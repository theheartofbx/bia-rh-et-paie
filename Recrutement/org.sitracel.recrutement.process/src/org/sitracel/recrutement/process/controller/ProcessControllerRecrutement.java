...
/**
 * Contrôleur des actions Valider/Rejeter du module Recrutement.
 *
 * Corrigé Session 18 : ajout validerCandidature / rejeterCandidature.
 */
public class ProcessControllerRecrutement {
    ...
    public static void validerOffreEmploi(Integer offreEmploiID, Integer adUserID) {
        if (offreEmploiID == null || adUserID == null) return;
        ...
        if (bi == null || offreEmploi == null || offreEmploi.get_ID() == 0) return;
    ...
    public static void validerSessionRecrutement(Integer sessionRecrutementID, Integer adUserID) {
        if (sessionRecrutementID == null || adUserID == null) return;
        BeanIdentifiant bi = MCBPartner.getIdentifiant(adUserID, null);
        MHRSessionRecrutement sessionRecrutement = new MHRSessionRecrutement(Env.getCtx(), sessionRecrutementID, null);
        if (bi == null || sessionRecrutement == null || sessionRecrutement.get_ID() == 0) return;
    ...
    public static void validerTestEvaluation(Integer testEvaluationID, Integer adUserID) {
        if (testEvaluationID == null || adUserID == null) return;
        BeanIdentifiant bi = MCBPartner.getIdentifiant(adUserID, null);
        MHROffreTestEvaluation testEvaluation = new MHROffreTestEvaluation(Env.getCtx(), testEvaluationID, null);
        if (bi == null || testEvaluation == null || testEvaluation.get_ID() == 0) return;
    ...
    public static void validerCandidature(Integer candidatureID, Integer adUserID) {
        if (candidatureID == null || adUserID == null) return;
        BeanIdentifiant bi = MCBPartner.getIdentifiant(adUserID, null);
        MHRCandidature candidature = new MHRCandidature(Env.getCtx(), candidatureID, null);
        if (bi == null || candidature == null || candidature.get_ID() == 0) return;
    ...
    public static void rejeterCandidature(Integer candidatureID, Integer adUserID) {
        if (candidatureID == null || adUserID == null) return;
        BeanIdentifiant bi = MCBPartner.getIdentifiant(adUserID, null);
        MHRCandidature candidature = new MHRCandidature(Env.getCtx(), candidatureID, null);
        if (bi == null || candidature == null || candidature.get_ID() == 0) return;
