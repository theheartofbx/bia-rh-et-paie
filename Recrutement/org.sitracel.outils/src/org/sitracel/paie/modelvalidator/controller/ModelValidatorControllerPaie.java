...
public class ModelValidatorControllerPaie {
		...
		if(calculPaie!=null) {
			if(type==ModelValidator.TYPE_AFTER_NEW || type==ModelValidator.TYPE_AFTER_CHANGE) {
				...
				if(historiquePaie==null) {
					...
					historiquePaie.setHR_Historique_Paie_ID(DB.getNextID(Env.getCtx(), MHRHistoriquePaie.Table_Name, null));
				}
	...
	public static void actualiserPoste(MHRElementBasePaieEmploye elementBasePaieEmploye, int type) {
		if(elementBasePaieEmploye!=null) {
			Timestamp oldDateDebut = (Timestamp)elementBasePaieEmploye.get_ValueOld(MHRElementBasePaieEmploye.COLUMNNAME_Date_Debut);
			...
			if(type==ModelValidator.TYPE_AFTER_NEW || type==ModelValidator.TYPE_AFTER_CHANGE) {
				if(employeeJob==null) {
					...
					employeeJob.setHR_EmployeeJob_ID(DB.getNextID(Env.getCtx(), MHREmployeeJob.Table_Name, null));
				}
